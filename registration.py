...
l7.place(x=540, y=350)
# gender
tk.Radiobutton(window, text="Male", padx=5, width=5, bg="snow", font=("bold", 15), variable=var, value=1).place(x=750,
                                                                                                                y=350)
...
l10.place(x=540, y=550)

t10 = tk.Entry(window, textvar=password1, width=20, font=('', 15), show="*")
t10.place(x=750, y=550)

btn = tk.Button(window, text="Register", bg="#192841",font=("",20),fg="yellow", width=9, height=1, command=insert)
btn.place(x=690, y=620)
